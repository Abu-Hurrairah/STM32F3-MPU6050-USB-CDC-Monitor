...
```text
stm32 stm32f3 stm32cubeide embedded-c mpu6050 i2c usb-cdc
virtual-com-port accelerometer gyroscope imu sensor hal firmware
...
- ✅ Original STM32F3 MPU6050 source preserved
- ✅ Original CubeMX `.ioc` preserved
- ✅ MPU6050 initialization and 6-axis processing present
- ✅ Development screenshots included
- ✅ USB CDC integration example included
- ℹ️ USB CDC integration should be generated/compiled inside the target CubeMX project before hardware use
